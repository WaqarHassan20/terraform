# ================================================================================= #
# ================================================================================= #
#     This is code for  bootstraping using provisioners on Digital Ocean #
# ================================================================================= #
# ================================================================================= #


provider "digitalocean" {
  token = "value-of-DO-token"
}
...
# ================================================================================= #
# ================================================================================= #
#     This is the code with syntax of using cide with VPC and all things on AWS     #
# ================================================================================= #
# ================================================================================= #
...
# ================================================================================= #
# ================================================================================= #
#    This is the conversion of code from AWS to Digital Ocean Platfrom somehow      #
# ================================================================================= #
# ================================================================================= #
...
# ------------------------------
# Step 2: VPC (City Walls)
# DigitalOcean VPC for private networking
# ------------------------------
...
# ------------------------------
# Step 3: Firewall (Bodyguards)
# Rules for who can enter/leave the droplet
# ------------------------------
...
# ------------------------------
# Step 4: Droplet (House)
# A small Ubuntu server in NYC3 region
# ------------------------------
resource "digitalocean_droplet" "server" {
  name     = "web-1"
  region   = "nyc3"
